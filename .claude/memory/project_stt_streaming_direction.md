...
- **Hardware**: user's GPU is RTX 5070 Laptop, 8 GB VRAM, Blackwell sm_120. CRITICAL: CTranslate2 INT8 is broken on sm_120 (`cuBLAS NOT_SUPPORTED`) — MUST use **float16** (~3 GB), CTranslate2 ≥4.5.0, CUDA 12.8.
