...
Switch {
    ...
    indicator: StyledRect {
        ...
        color: root.checked ? Qt.lighter(Colours.pillStyle(Colours.palette.m3primary, Colours.glass.veryStrong).background, 1.5) : Colours.layer(Colours.palette.m3surfaceContainerHighest, root.cLayer)
        ...
        StyledRect {
            ...
            radius: Appearance.rounding.full
            color: root.checked ? Colours.palette.m3onSurface : Colours.layer(Colours.palette.m3outline, root.cLayer + 1)
            ...
            Shape {
                ...
                ShapePath {
                    ...
                    strokeColor: root.checked ? Colours.palette.m3onSurface : Colours.palette.m3surfaceContainerHighest
