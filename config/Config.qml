...
Singleton {
    ...
    function serializeKeycaster(): var {
        return {
            enabled: keycaster.enabled,
            historyLength: keycaster.historyLength,
            fadeoutDelay: keycaster.fadeoutDelay,
            fadeoutDuration: keycaster.fadeoutDuration
        };
    }
