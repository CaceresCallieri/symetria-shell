...
import ".."  // drawers directory — Panels, Interactions, Border, Exclusions
import "../../bar" as BarModule
import "../../agentbar" as AgentBarModule
import "../../keychords" as KeyChordsModule
import Quickshell
    ...
    StyledWindow {
        ...
        Item {
            ...
            Loader {
                anchors.fill: parent
                asynchronous: true
                Component.onCompleted: setSource(Qt.resolvedUrl("../backgrounds/Backgrounds.qml"), {
                    panels: panels,
                    bar: bar,
                    agentBar: agentBar
                })
