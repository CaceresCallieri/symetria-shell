            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    ColumnLayout {
                        ...
                        WorkspacesSettings {
                            shown: root.workspacesShown
                            showOnlyOccupied: root.workspacesShowOnlyOccupied
                            activeIndicator: root.workspacesActiveIndicator
                            occupiedBg: root.workspacesOccupiedBg
                            showWindows: root.workspacesShowWindows
                            perMonitor: root.workspacesPerMonitor
                            pillBackground: root.settingsPill.background
                            pillBorder: root.settingsPill.border
